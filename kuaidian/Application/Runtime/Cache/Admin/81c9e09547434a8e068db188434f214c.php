...
<form class="form-inline" action="/index.php/Admin/User/lst.html"  method="get">  
    店铺名称：
...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <?php if(!empty($data)): if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
        ...
        <td>
        <?php if($vo['status'] == 0): ?><a href="javascript:void(0);"  class="enable" _userid="<?php echo ($vo['id']); ?>">启用</a><?php endif; ?>
        </td>
...
<script>
	$(function(){
		...
		$('.enable').click(function(){
			...
			//$.post("<?php echo U('Store/edit');?>", {ids : userid}, function(obj){
